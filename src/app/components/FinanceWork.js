          ...
          <div className="w-full px-4 lg:w-1/2 2xl:w-5/12">
            <div className="sm:mt-10 xs:mt-14 lg:mt-0">
              ...
              <p className="text-base text-body-color mb-9">
                ...
                answer any questions you may have. Count on us for competitive
                rates and a hassle-free financing experience.
              </p>
              <div className="space-y-2">
                <List>Secure Application</List>
                <List>Transparent. No Pressure.</List>
                <List>Best Rates</List>
              </div>
            </div>
          </div>
        </div>
