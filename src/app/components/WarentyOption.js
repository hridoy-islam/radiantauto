      ...
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="-mx-4 flex flex-wrap">
            <PricingCard
              type="Basic Coverage"
              description="Radiant Auto PRINCIPAL"
            >
              <List>Engine mechanicals, transmission and drivetrain</List>
              <List>24-hour roadside assistance</List>
            </PricingCard>
            <PricingCard
              type="Comprehensive Coverage"
              description="Radiant Auto PLUS"
            >
              <List>Engine mechanicals, transmission and drivetrain</List>
              <List>24-hour roadside assistance</List>
              <List>Engine cooling system</List>
            </PricingCard>
            <PricingCard
              type="Premium Coverage"
              description="Radiant Auto PINNACLE"
            >
              <List>Everything covered with Principal and Plus</List>
              <List>Electrical</List>
              <List>Fuel system</List>
              <List>Brakes</List>
              <List>Steering</List>
              <List>Climate Control</List>
            </PricingCard>
          </div>
        </div>
        <div className="flex justify-center items-center">
          <Button text={"Download Brochure"} link={"/"} />
        </div>
      </div>
    </section>
  );
...
export default WarentyOption;

const PricingCard = ({ children, description, type }) => {
  return (
    <>
