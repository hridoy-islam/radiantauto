          ...
          <div className="relative z-10 overflow-hidden rounded bg-primary py-12 px-8 md:p-[70px]">
            <div className="flex flex-wrap items-center -mx-4">
              <div className="w-full px-4 lg:w-2/3">
                <h2 className="mb-6 font-bold leading-tight text-white sm:mb-8 sm:text-[40px]/[48px] lg:mb-0">
                  <span className="xs:block">
                    {" "}
                    Finance your next car. We will find the best rates and get
                    you approved in minutes.{" "}
                  </span>
                </h2>
              </div>
