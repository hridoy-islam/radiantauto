            ...
            <div className="w-full px-4">
              <div className="flex flex-wrap -mx-4">
                <div className="w-full px-4 lg:w-8/12">
                  <div>
                    <p className="flex items-center mr-5 mb-8 text-sm font-medium text-dark md:mr-6">
                      <span className="mr-3">
                        <svg
                          width="16"
                          height="16"
