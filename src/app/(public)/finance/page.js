...
export default function Finance() {
  ...
  useEffect(() => {
    gsap.fromTo(
      ...
      { opacity: 0, y: 40 },
      { opacity: 1, y: 0, duration: 0.8, stagger: 0.15, ease: "power3.out", scrollTrigger: { trigger: sectionRef.current, start: "top 85%", toggleActions: "play none none none" } }
    );
  }, []);
            ...
            {[
              ...
              <div key={i} className="py-10 px-8 text-center">
                <span className="block text-4xl font-bold text-primary">
                  <CountUp end={stat.end} suffix={stat.suffix} decimals={stat.suffix === "%" && stat.end < 10 ? 1 : 0} />
                </span>
        ...
        <div className="container mx-auto">
          <div className="mx-auto mb-14 max-w-2xl text-center gsap-fade">
            ...
            <p className="text-gray-500">
              We partner with Canada&apos;s top lenders to bring you the best rates and most flexible terms.
            </p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {benefits.map((item, i) => (
              <div key={i} className="gsap-fade rounded-2xl bg-white border border-gray-100 p-6 shadow-sm hover:shadow-lg transition-shadow">
