              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                {isSuccessDisable ? (
                  <div className="py-12 text-center">
                    ...
                    <p className="text-base text-body-color">
                      Thank you for contacting us. Your message has been successfully received, and our team will get back to you shortly.
                    </p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-4">
                      <textarea
                        ...
                        name="content"
                        className={`input ${errors.content ? 'border-red-500 focus:border-red-500' : ''}`}
                        {...register("content")}
                        disabled={isSubmitting}
                      />
                      {errors.content && (
                    ...
                    <div>
                      <button
                        type="submit"
                        disabled={isSubmitting}
                        className="w-full rounded border border-primary bg-primary p-3 text-white transition hover:bg-opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
